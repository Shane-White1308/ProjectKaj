        ...
        <header className="bg-yellow-500 sticky top-0 z-[1001]">
          <nav className="mx-auto flex items-center justify-between p-6 lg:px-8" >
            ...
            <div className="flex lg:hidden gap-x-3 lg:flex-1 lg:justify-end">
              <Link to="/user"> <img src={userIcon} alt="user" className="h-5 w-5 object-contain"/></Link>
              <Link to="/favourite"> <img src={favouriteIcon} alt="favourite" className="h-5 w-5 object-contain"/></Link>
              <Link to={window.location.pathname + "?action=cart"}><img src={cartIcon} alt="cart" className="h-5 w-5 object-contain"/></Link>
            </div>
            ...
            <div className="hidden lg:flex lg:gap-x-12">
              ...
              <div className="relative group">
                ...
                <div className="absolute -left-8 top-full z-[1001] mt-3 w-screen max-w-md max-h-0 group-hover:max-h-96 overflow-y-hidden group-hover:overflow-y-auto rounded-lg bg-yellow-500 transition-[max-height] duration-500">
                  <div className="p-4">
                    <Link to="/collection/facewash" className="uppercase block font-semibold text-gray-900 rounded-lg hover:bg-gray-50 p-2">
                      Face Wash
                    </Link>
              ...
              <div className="relative group">
                ...
                <div className="absolute -left-8 top-full z-[1001] mt-3 w-screen max-w-md max-h-0 group-hover:max-h-96 overflow-y-hidden group-hover:overflow-y-auto rounded-lg bg-yellow-500 transition-[max-height] duration-500">
                  <div className="p-4">
                    <Link to="/collection/soaps" className="uppercase block font-semibold text-gray-900 rounded-lg hover:bg-gray-50 p-2">
                      Soaps
                    </Link>
          ...
          {mobileMenuOpen && <div className="lg:hidden">
            ...
            <div className="fixed inset-y-0 right-0 z-[1001] w-full overflow-y-auto bg-yellow-500 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
              <div className="flex items-center justify-between">
                ...
                >
                  <img src={closeIcon} className="h-6 w-6" alt="Close menu" aria-hidden="true"/>
                </button>

                <Link to="#" className="-m-1.5 p-1.5">
                  <span className="sr-only">Your Company</span>
                  <img src={kaj} alt="Website name" className="h-8 w-auto rounded-full"/>
                </Link>
              </div>
              ...
              <div className="mt-6 flow-root">
                <div className="-my-6 divide-y divide-gray-500/10">
                  <div className="space-y-2 py-6">
                    <Link to="#" className="-mx-3 block rounded-lg px-3 py-2 text-sm font-semibold leading-7 text-gray-700 hover:bg-gray-50">
                      Link 1
                    </Link>

                    <div>
                      <p className="-mx-3 block px-3 py-2 text-base font-medium text-gray-900">Category 1</p>

                      <Link to="#" className="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-700 hover:bg-gray-50">
                        Option 1
                      </Link>
                    ...
                    <div>
                      <p className="-mx-3 block px-3 py-2 text-base font-medium text-gray-900">Category 2</p>
