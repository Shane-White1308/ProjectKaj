    ...
    return (
            <div key={product.id} className="relative group w-full flex flex-col gap-3">
                ...
                <div className="flex flex-col w-full gap-1.5">
                    ...
                    <p className="text-center text-lg font-semibold">{product.offerPrice !== product.originalPrice ?
                        <>
                    ...
                    <button type="button" className="bg-white hover:bg-black text-black hover:text-white text-md px-4 py-2 rounded-full border border-solid border-black text-center w-full uppercase">Add to cart</button>
                </div>
            </div>
    );
}
