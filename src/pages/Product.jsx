...
const Product = () => {
    ...
    useEffect(() => {
        ...
        let totalReviews = star1_count + star2_count + star3_count + star4_count + star5_count

        const temp = {
            rating: parseInt((star1_count + 2*star2_count + 3*star3_count + 4*star4_count + 5*star5_count) / totalReviews),
    ...
    return <>
        ...
        <ProductList heading="Recommendations" products={recommended} columns={5}/>
